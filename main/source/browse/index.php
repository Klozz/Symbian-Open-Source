...
<title>Symbian developer community - browse code</title>
<meta name="description" content="Browse source code files. Perform code searches." />
<meta name="keywords" content="Symbian, source code" />
...
$(document).ready(function(){
	//$("#pagecol0").equalHeights(true);	
	//$("#pagecol1").equalHeights(true);	
	//$("#pagecol2").equalHeights(true);
	//$(".equalCol").equalHeights(true);
...
// document ready
 ...
 <!--googleon: all-->
  ...
  <div id="subheader">
    <div class="left">
      <div class="breadcrumbs"><a href="/">Home</a> &gt; &nbsp;<a href='/main/source/'>Source</a>&nbsp;>&nbsp;Browse code</div>
      <h2 class="cssImg source_headline"><span class="img_t_browse_code">Browse code</span></h2>
    </div>
					...
					<a href="/main/emailfriend.php?url=http%3A%2F%2Fdeveloper.symbian.org%2Fmain%2Fsource%2Fbrowse%2Findex.php&amp;TB_iframe=true&amp;height=85%&amp;width=650" class="thickbox" title="Email a friend">
  ...
  <div id="contentContainer">
    ...
    <div class="subcontent">
      <div id="genericContent" class="top">
        ...
        <div class="right"><img src="/img/landing_pages/sf_devimg_25.gif" alt="Browse code" class="subcontentImage" /></div>
        <p>Information about the Symbian Code Licenses can be <a href="../license/index.php">found here</a>.</p>
      </div>
      <div class="clear"></div>
      <div id="colcontainer1" >
        <!--Council Pages-->
        <div class="left BoxFrame two_col"> <img src="/img/landing_pages/sf_webdev_05.gif" alt="OSS code" border="0" class="community_image right" />
          <h2 class="cssImg community_header"><span class="img_t_oss_code">Version control</span></h2>
          	<p>Browse source code files and view history of changes for the OSS and SFL packages</p>
            <div class="community_copy">
            <ul class="bodyList">
              <li><a href="/oss/" class="more_info">Browse OSS code</a></li>
              <li><a href="/sfl/" class="more_info">Browse SFL code</a></li>
            </ul>
            </div>
        </div>
        <!--Platform Dashboard-->
        <div class="right BoxFrame two_col"> <img src="/img/landing_pages/sf_devimg_24.gif" alt="SFL code" border="0" class="community_image right" />
          <h2 class="cssImg community_header"><span class="img_t_sfl_code">Cross referencer</span></h2>
          	<p>Perform code searches within OSS and SFL packages</p>
          <div class="community_copy">
            <ul class="bodyList">
              <li><a href="/xref/oss/" class="more_info">Search OSS code</a> </li>
              <li><a href="/xref/sfl/" class="more_info">Search SFL code</a></li>
            </ul>
          </div>
        </div>
        <div class="clear"></div>
