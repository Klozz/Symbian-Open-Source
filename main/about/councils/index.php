...
<title>Symbian developer community - councils</title>
<meta name="description" content="The Symbian Foundation Councils support the development community." />
<meta name="keywords" content="Symbian, Symbian developer community, council, development community, software releases" />
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#colcontainer3").equalHeights(true);	
		highlightMenu("m_item7");
	});
</script>
...
<div id="subheader">
		<div class="left">
			<div class="breadcrumbs"><a href="/">Home</a> &gt; &nbsp;<a href='/main/about/'>About</a>&nbsp;>&nbsp;Councils</div>
			<h2 class="cssImg foundation_councils_headline"><span class="img_foundation_councils_headline">Councils</span></h2>
		</div>
					...
					<a href="/main/emailfriend.php?url=http%3A%2F%2Fdeveloper.symbian.org%2Fmain%2Fabout%2Fcouncils%2Findex.php&amp;TB_iframe=true&amp;height=85%&amp;width=650" class="thickbox" title="Email a friend">
  ...
  <div class="right"><img src="/img/landing_pages/sf_devimg_40.gif" alt="Councils" class="subcontentImage" /></div>
  <p>The Symbian Foundation Councils exist to support the development community and grow the competitiveness of the Symbian platform by:</p>
	<ul class="bulletlist">
		<li>Identifying high-level market, user and technical requirements</li>
		<li>Soliciting contributions that address those requirements</li>
		<li>Coordinating community contributions into regular platform releases</li>
		<li>Providing transparency for all community members regarding future platform developments</li>
	</ul>

	<p>Each council is comprised of representative members of the community plus a (non-voting) chair drawn from the foundation staff of the Symbian Foundation. Together the councils constitute the decision-making bodies governing the contents and specifications of Symbian software releases. The councils also act as caretakers and improvers of the community's collaborative process.</p>
	<p>An overview of the proposals pipeline is available <a href="/wiki/index.php/Proposals_pipeline" title="Proposals pipeline">here</a>.</p>
	
	<p>The <a href="/wiki/index.php/Symbian_Foundation_Council_Charters">Symbian Foundation Council Charters document</a> describes the collective and individual functioning of the councils. It covers common issues such as membership and chairing plus the key objectives and decision-making responsibilities of each Council. Each council has its own distinct set of responsibilities, which together are designed to complement each other and provide coordinated support for contributors and community members.</p>	
	</div>
	
	<div class="clear10"></div>
  </div>
  <!--END of page content-->
  <!--START of row 1 content-->
  <div id="colcontainer1" class="columns">
    <!--Feature and Roadmap Council-->
    <div class="left BoxFrame two_col"> <a href="/main/about/councils/council/feature_and_roadmap_council.php"><img src="/img/landing_pages/sf_devimg_09.gif" alt="Feature and Roadmap Council"  border="0" class="community_image right" /></a>
	      <h2 class="cssImg community_header"><a href="/main/about/councils/council/feature_and_roadmap_council.php" id="rollover_feat_roadmap_council"><span>Feature and Roadmap Council</span></a></h2>
      <p class="two_col_copy">The Feature and Roadmap Council invites proposals for contributions from the community and seeks to coordinate new contributions into a unified platform (or tools) roadmap.</p>      
    </div>
    <!--Architecture Council-->
    <div class="right BoxFrame two_col"> <a href="/main/about/councils/council/architecture_council.php"><img src="/img/landing_pages/sf_devimg_10.gif" alt="Architecture Council" border="0" class="community_image right" /></a>
	      <h2 class="cssImg community_header"><a href="/main/about/councils/council/architecture_council.php" id="rollover_archit_council"><span>Architecture Council</span></a></h2>
      <p class="two_col_copy">The Architecture Council invites and reviews technical solutions for new contributions in order to ensure the architectural integrity, backward compatibility and fitness-for-purpose of enhancements to the platform.</p>
    </div>
  </div>
  <div class="clear"></div>
  ...
  <div id="colcontainer2" class="columns">
    <!--UI Council-->
    <div class="left BoxFrame two_col"> <a href="/main/about/councils/council/ui_council.php"><img src="/img/landing_pages/sf_devimg_33_small.gif" alt="The User Interface Council" border="0" class="community_image right" /></a>
	      <h2 class="cssImg community_header"><a href="/main/about/councils/council/ui_council.php" id="rollover_ui_council"><span>UI Council</span></a></h2>
      <p class="two_col_copy">The User Interface Council invites and reviews descriptions of new user interface elements and develops guidelines to help ensure high quality device user experiences.</p>      
    </div>
    <!--Release Council-->
    <div class="right BoxFrame two_col"> <a href="/main/about/councils/council/release_council.php"><img src="/img/landing_pages/sf_devimg_12.gif" alt="The Release Council" border="0" class="community_image right" /></a>
	      <h2 class="cssImg community_header"><a href="/main/about/councils/council/release_council.php" id="rollover_release_council"><span>Architecture Council</span></a></h2>
      <p class="two_col_copy">The Release Council coordinates the integration of contributions into stable and timely platform and tools releases.</p>
    </div>
  </div>
  <div class="clear"></div>
  <div class="colcontainerspacer"></div>
