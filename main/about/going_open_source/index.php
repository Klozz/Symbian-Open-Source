...
<title>Symbian developer community - going open source</title>
<meta name="description" content="Why did we create the Symbian Foundation? Here is our reasoning." />
<meta name="keywords" content="Symbian, Symbian Foundation, open source, mobile devices, applications" />
...
// document ready
 ...
 <!--googleon: all-->
  ...
  <div id="subheader">
    <div class="left">
      <div class="breadcrumbs"><a href="/">Home</a> &gt; &nbsp;<a href='/main/about/'>About</a>&nbsp;>&nbsp;Going open source</div>
      <h2 class="cssImg going_open_headline"><span class="img_going_open_headline">Going open source</span></h2>
    </div>
					...
					<a href="/main/emailfriend.php?url=http%3A%2F%2Fdeveloper.symbian.org%2Fmain%2Fabout%2Fgoing_open_source%2Findex.php&amp;TB_iframe=true&amp;height=85%&amp;width=650" class="thickbox" title="Email a friend">
  ...
  <div id="contentContainer">
    <div class="subcontent">
      <div id="genericContent" class="contactUs graphicHeaders">
        <div class="right"><img src="/img/landing_pages/sf_devimg_44.gif" alt="About Symbian Foundation" class="subcontentImage landingImage" /></div>
        
        <h3 class="topHeading">Why was the Symbian Foundation founded? Here is our reasoning.</h3>
        <div class="clearLeft"></div>
        <h2 class="cssImg" id="going_open_enormous"> <span class="img_t_going_open_enormous">The industry faces enormous opportunities and challenges</span></h2>
        <ul class="bulletlist_padded">
          <li>Smart mobile devices are becoming astonishingly powerful. With connections to increasingly sophisticated networks, they promise ever more innovative new applications and services</li>
          <li>Industries such as media, gaming, banking, retail, travel, health, journalism, education, data processing and government (…the list goes on) have seen the potential, and are rapidly developing new uses for mobile devices</li>
          <li>The increasing complexity of mobile devices makes them more difficult to manufacture and program, more difficult to use and reduces their battery life</li>
          <li>Open devices on open networks could endanger privacy and security</li>
        </ul>
        <h2 class="cssImg" id="going_open_involving"><span class="img_t_going_open_involving">By involving more people, more of these opportunities can be addressed</span></h2>
        <ul class="bulletlist_padded">
          <li>The number of smart and capable people outside an organisation always far exceeds the number on the inside</li>
          <li>Freely available standard programming interfaces are an important first step to involving more people - but they only go so far</li>
          <li>Freely available source code, that is open to modification and experiment, enables deeper and more substantial collaboration: collaboration in the evolution and refinement of the platform itself, rather than application development on top</li>
        </ul>
        <h2 class="cssImg" id="going_open_legacy"><span class="img_t_going_open_legacy">The Symbian platform has a unique legacy</span></h2>
        <p class="listHeader">The Symbian platform is already a robust, cohesive, well proven, high-performance software system, whose scope covers the complete needs of mobile developers - from the metal, via extensive middleware, to applications and UIs. This stable base is an excellent starting point for further improvement. <br>Many key personnel within the Symbian Foundation and the founding organisations have more than a decade of Symbian experience. The Foundation has battle-hardened skills in:
</p>
        <ul class="bulletlist_padded">
          <li>Roadmap design and execution</li>
          <li>Managing software interfaces, platform compatibility, and rapid integration</li>
          <li>Dealing simultaneously with disparate powerful customers having divergent interests</li>
          <li>Mixing agile and modular development with overall architectural integrity</li>
          <li>Overnight builds, codeline management and quality gate-keeping</li>
        </ul>
       
	<h2 class="cssImg" id="going_open_road"><span class="img_t_going_open_road">The road ahead</span></h2>
	
        <p>We’ve made a strong start by opening the Symbian platform source code four months ahead of schedule, but the road ahead is likely to contain pot-holes. To help us keep our footing, the following principles will be our guidelines:</p>
		
        <ul class="bodytext">
          <li><strong>Practice not just open source but also open decision making and open governance.</strong> In this way we can benefit from the best ideas, and retain the maximum goodwill and trust from the entire community</li>
          <li><strong>Aim to build bridges and overcome divisions.</strong> We must find ways to work with potential partners who have different outlooks, motivations and business models</li>
          <li><strong>Value and respect developers.</strong> It is developers who provide the creative energy and insight to craft and re-craft the products that meet end-users' needs on every level</li>
          <li><strong>Seek to engage the heart as well as the head.</strong> We must ignite and sustain intelligent passion to fulfil our vision of &quot;freedom to create&quot;</li>
        </ul>
        <a class="more_info top_margin" href="/wiki/index.php/Category:FAQ">Read the FAQs</a></div>
    </div>
  </div>
