...
<title>Symbian developer community - get involved</title>
<meta name="description" content="Ways everyone can join in and contribute." />
<meta name="keywords" content="Symbian, Symbian Foundation, developers, community" />
...
<link rel="stylesheet" type="text/css" href="/css/sIFR-screen.css" />
<style type="text/css">
<!--
...
// document ready
 ...
 <!--googleon: all-->
  ...
  <div id="subheader">
    <div class="left">
      <div class="breadcrumbs"><a href="/">Home</a> &gt; &nbsp;<a href='/main/about/'>About</a>&nbsp;>&nbsp;Get involved</div>
      <h2 class="blockhead_up">Get involved</h2>
    </div>
					...
					<a href="/main/emailfriend.php?url=http%3A%2F%2Fdeveloper.symbian.org%2Fmain%2Fabout%2Fget_involved%2Findex.php&amp;TB_iframe=true&amp;height=85%&amp;width=650" class="thickbox" title="Email a friend">
  ...
  <div id="contentContainer">
    <div class="subcontent">
      <div id="genericContent" class="contactUs">
        <div class="right"><img src="/img/landing_pages/sf_devimg_32.gif" alt="" class="subcontentImage" /></div>
        <p>Being open requires the enthusiasm and graft of many people. We need your
          help.<br />
          You don't need to spend lots of time to make a big difference!</p>
        <h3 class="cssImg" id="involved"><span class="img_t_involved">What can you get involved in?</span></h3>
        <div class="clear"></div>
      </div>
      <div id="colcontainer1">
        <div class="left BoxFrame two_col">
          <div class="colBoxTop">
            <h4>Ways everyone can join in</h4>
          </div>
          <ul class="bulletlist_padded">
            <li>Follow our <a href="http://blog.symbian.org/" target="_blank">blog</a> and leave us comments</li>
            <li>Follow us on <a href="http://www.twitter.com" target="_blank">Twitter</a>
              <ul>
                <li> - <a href="http://www.twitter.com/symbian" target="_blank">@symbian</a> is for all gadget enthusiasts, industry watchers, technology aficionados and so on.</li>
                <li> - <a href="http://www.twitter.com/symbiandevco" target="_blank">@symbiandevco</a> is for news, initiatives and conversations within the Symbian developer community</li>
              </ul>
            </li>
            <li>Talk to us at an <a target="_blank" href="http://www.symbian.org/events">event</a></li>
            <li>Join our <a href="http://www.symbian.org/about-us/jobs-symbian" target="_blank">team</a> </li>
          </ul>
        </div>
        <div class="right BoxFrame two_col">
          <div class="colBoxTop">
            <h4>Ways developers can contribute</h4>
          </div>
          <ul class="bulletlist_padded">
            <li><a href="/bugs/">Report a bug</a></li>
            <li><a href="/wiki/index.php/Defect_Handling_Guidelines">Fix a bug</a></li>
            <li><a href="/main/about/councils/council/feature_and_roadmap_council.php">Propose a new feature</a></li>
			<li><a href="/wiki/index.php/Contribution_Process">Contribute code</a></li>
            <li><a href="/wiki/index.php/What_are_the_Kits%3F#Carbide.c.2B.2B_Development_Kit_.28CDK.29">Extend</a> our tools</li>
            <li><a target="_blank" href="http://symbian.org/members">Become a member</a></li>
            <li><a href="/wiki/index.php/Help:Contributing_to_this_Wiki">Write and edit</a> developer documentation and example code in the wiki</li>
            <li><a href="/forum/">Help other developers on the support forums</a></li>
            <li><a href="/wiki/index.php/Contribute_to_Symbian_Books">Write or edit a Symbian book</a> </li>
          </ul>
        </div>
      </div>
    </div>
...
if(typeof sIFR == "function"){
	...
	sIFR.replaceElement(named({sSelector:"#subheader h2.blockhead_up, #bodyText h2.blockhead_up", sFlashSrc:"/img/blockhead-unplugged.swf", sColor:"#000", sLinkColor:"#000", sBgColor:"#ffffff", sHoverColor:"#000", nPaddingTop:5, nPaddingBottom:5, sFlashVars:"textalign=left&w=200&h=15", sWmode:"transparent"}));
};
