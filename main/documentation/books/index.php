...
<title>Symbian developer community - books</title>
<meta name="description" content="Books for Symbian developers" />
<meta name="keywords" content="Symbian, developer, documentation, articles, help, books" />
...
// document ready
 ...
 <!--googleon: all-->
  ...
  <div id="subheader">
    <div class="left">
      <div class="breadcrumbs"><a href="/">Home</a> &gt; &nbsp;<a href='/main/documentation/'>Documentation</a>&nbsp;>&nbsp;Books</div>
      <h2 class="cssImg books_headline"><span class="img_t_books_headline">Books</span></h2>
    </div>
					...
					<a href="/main/emailfriend.php?url=http%3A%2F%2Fdeveloper.symbian.org%2Fmain%2Fdocumentation%2Fbooks%2Findex.php&amp;TB_iframe=true&amp;height=85%&amp;width=650" class="thickbox" title="Email a friend">
  ...
  <div id="contentContainer">
    <div class="subcontent">
      ...
      <div id="genericContent" class="top">
                <div class="right"><img src="/img/landing_pages/sf_devimg_05.gif"  alt="Books" class="subcontentImage" /></div>
        <p>A number of books about Symbian are available in print and electronic formats.
          Some books are also available on our wiki, and we welcome updates. If you spot
          typos or sections that need changing in our wiki books, feel free to fix them,
          or post a comment on the discussion boards to let us know.</p>
        <p>Books are also available in translation to Japanese and Chinese, and available
          in India with regional pricing.</p>
        <p>Find out more and browse our bookshelf!</p>
      </div>
      <div class="clear"></div>
      <div id="colcontainer1">
        <div class="left BoxFrame two_col"><a href="/wiki/index.php/The_Open_Source_Alternative"><img src="/img/landing_pages/sf_devimg_13.gif" alt="Book of the month" border="0" class="community_image right" /></a>
        <h2 class="cssImg community_header"><a href="/wiki/index.php/The_Open_Source_Alternative" id="rollover_book_of_the_month"><span>Book of the month</span></a></h2>
          <p class="community_copy">Our book of the month, "The Open Source Alternative" explains licensing in a language anyone can follow. By agreement with John Wiley & Sons Ltd, we're providing the first three chapters of the book free on this site.
          	<a class="more_info top_margin" href="/wiki/index.php/The_Open_Source_Alternative">Read on here</a></p>
        </div>
        <div class="right BoxFrame two_col"> <a href="/wiki/index.php/Category:Book"><img src="/img/landing_pages/sf_devimg_14.gif" alt="Online books"  border="0" class="community_image right" /></a>
        	<h2 class="cssImg community_header"><a href="/wiki/index.php/Category:Book" id="rollover_online_books"><span>Online books</span></a></h2>
			 <p class="community_copy">A selection of Symbian-related books are available online via our<a href="/wiki/index.php/Category:Book"> Wiki</a>.</p>
           <ul class="bulletlist_padded">
            <li><a href="/wiki/index.php/Symbian_OS_Communications_Programming">Symbian OS Communications Programming</a></li>
            <li><a href="/wiki/index.php/Writing_portable_code_and_maintaining_ports">Writing Portable Code and Maintaining Ports</a></li>
            <li><a href="/wiki/index.php/Symbian_OS_Internals">Symbian OS Internals</a> </li>
	     <li><a href="/wiki/index.php/Demand_Paging_on_Symbian">Demand Paging on Symbian</a> </li>
          </ul>
        </div>
        <!-- 
        <div class="right BoxFrame three_col">
           TODO: Need this graphic. No head here.
          <p class="community_copy">eBook, Packt Publishing</p>
        </div>
        -->
      </div>
      <div class="clear"></div>
      ...
      <div id="colcontainer2">
        <div class="left BoxFrame three_col">
          ...
          <p class="community_copy">Find out how to contribute to Symbian books <a href="/wiki/index.php/Contribute_to_Symbian_Books">here</a>.</p>
        </div>
        <div class="left BoxFrame three_col three_col_center">
          ...
          <ul class="bulletlist_padded">
            <li><a href="http://developer.symbian.org/wiki/index.php/Symbian_Press_Books_A_to_Z_by_Author">A-Z by Author</a></li>
            <li><a href="http://developer.symbian.org/wiki/index.php/Symbian_Press_Books">A-Z by Title</a></li>
          </ul>
        </div>
        <div class="right BoxFrame three_col four_col_center">
          ...
          <ul class="bulletlist_padded">
            <li><a href="/wiki/index.php/Symbian%E5%87%BA%E7%89%88%E7%9A%84%E4%B8%AD%E6%96%87%E5%9B%BE%E4%B9%A6/zh-hans">China</a></li>
            <li><a href="/wiki/index.php/%E3%82%B7%E3%83%B3%E3%83%93%E3%82%A2%E3%83%B3%E3%83%97%E3%83%AC%E3%82%B9%E6%9B%B8%E7%B1%8D%EF%BC%88%E7%BF%BB%E8%A8%B3%E7%89%88%EF%BC%89/ja">Japan</a></li>
            <li><a href="/wiki/index.php/Symbian_Books_in_India">India</a></li>
          </ul>
        </div>
      </div>
      <div class="clear"></div>
