...
<title>Symbian developer community - Symbian Signed</title>
<meta name="description" content="Symbian Signed allows developers to sign an application for deployment to Symbian devices." />
<meta name="keywords" content="Symbian Signed, application, developers, Symbian devices, self signing" />
...
// document ready
 ...
 <!--googleon: all-->
  ...
  <div id="subheader">
    <div class="left">
      <div class="breadcrumbs"><a href="/">Home</a> &gt; &nbsp;<a href='/main/services/'>Services</a>&nbsp;>&nbsp;Symbian Signed</div>
      <h2 class="cssImg symbian_signed_headline"><span class="img_t_symbian_signed_headline">Symbian Signed</span></h2>
    </div>
					...
					<a href="/main/emailfriend.php?url=http%3A%2F%2Fdeveloper.symbian.org%2Fmain%2Fservices%2Fsymbian_signed%2Findex.php&amp;TB_iframe=true&amp;height=85%&amp;width=650" class="thickbox" title="Email a friend">
  ...
  <div class="subcontent">
    <div id="genericContent" class="top">
	 <div class="right"><img src="/img/landing_pages/sf_devimg_52.gif" alt="Symbian Signed" class="subcontentImage" /></div>
      <p>Symbian Signed is managed by the Symbian Foundation on behalf of the community
		and allows developers to sign an application for deployment to Symbian devices.</p>
      <p>The more sensitive functionality within the Symbian platform is protected by a
        'capabilities'-based model. Accessing sensitive functionality requires a
        selection of the respective capabilities and signing of an application through
        one of four options.  Which signing option depends on how the application is
        deployed - as a demo, beta test, or to the general public.
        </p>
      <p>Ready to sign and you know which option is best? Go to
        <a href="http://www.symbiansigned.com" target="_blank">http://www.symbiansigned.com</a>.  
        Unsure which signing option meets your needs,
        what tool(s) are required for a signing process or have an issue with a signing
        process and want to search a forum or make a post? Links at the bottom of the
        page will help.</p>
      <p>If you need support with signing your application, there are forums on this
        site where you can post your question. The Symbian Signed team here at the
        Symbian Foundation and other members of the community will attempt to answer
      ...
      <div id="colcontainer2">
        <div class="left BoxFrame two_col">
          ...
          <ul class="bulletlist_padded">
            <li><a href="/wiki/index.php/Category:Symbian_Signed">Symbian Signed Wiki</a></li>
            <li><a href="/wiki/index.php/Complete_Guide_To_Symbian_Signed">Complete Guide to Symbian Signed</a></li>
            <li><a href="/wiki/index.php/Symbian_Signed_Test_Criteria_(Symbian_Signed)">Symbian Signed Test Criteria</a></li>
            <li><a href="/wiki/index.php/Symbian_Signed_Tools">Tools</a></li>
          </ul>
        </div>
        <div class="right BoxFrame two_col">
          ...
          <ul class="bulletlist_padded">
            <li><a href="/forum/forumdisplay.php?f=5">Support Forum</a> </li>
            <li><a href="/forum/forumdisplay.php?f=17">General Signing Discussion Forum</a> </li>
          </ul>
        </div>
        </div>
      </div>
