...
<title>Symbian developer community - services</title>
<meta name="description" content="Services and programs provided by Symbian community." />
<meta name="keywords" content="Technical services, Symbian Signed, Technical support, training, professional services" />
 ...
 <!--googleon: all-->
  ...
  <div id="subheader">
    <div class="left">
      ...
      <h2 class="cssImg services_headline"><span class="img_t_services_headline">Services</span></h2>
    </div>
					...
					<a href="/main/emailfriend.php?url=http%3A%2F%2Fdeveloper.symbian.org%2Fmain%2Fservices%2Findex.php&amp;TB_iframe=true&amp;height=85%&amp;width=650" class="thickbox" title="Email a friend">
  ...
  <div id="contentContainer">
    <div class="subcontent">
      <div id="genericContent" class="top">
        <div class="right"><img src="/img/landing_pages/sf_webdev_19.gif"  alt="Services" class="subcontentImage" /></div>
        <p>As with most  things in the new Symbian world, tech support, training and professional  services are provided not by us, but by our community. </p>
        <p>The companies listed on  these pages are Symbian members, and we need to state the usual disclaimer:  listing on our pages doesn’t imply Symbian endorsement...you know the drill. </p>
      </div>
      <div class="clear"></div>
      <!--END of page content-->
      ...
      <div id="colcontainer1">
      	<div class="left BoxFrame two_col" style="min-height: 145px;margin-bottom:20px;"> <a target="_blank" href="http://horizon.symbian.org/"><img src="/img/landing_pages/sf_devimg_40_small.gif" alt="Symbian Horizon" border="0" class="community_image right" /></a>
          <h2 class="cssImg community_header"><a target="_blank" href="http://horizon.symbian.org/" id="rollover_symbian_horizon"><span>Symbian Horizon</span></a></h2>
          <p>Just like a book publisher seeks out the best authors, Symbian is looking for the best app developers. If you've got an application or an idea for an application that you will develop, and we like it, we'll publish it for you – for free.</p>
       </div>
	   
        <div class="right BoxFrame two_col" style="min-height: 145px;margin-bottom:20px;"> <a href="/main/services/symbian_signed/index.php"><img src="/img/landing_pages/sf_webdev_07.gif" alt="Symbian Signed" border="0" class="community_image right" /></a>
          <h2 class="cssImg community_header"><a href="/main/services/symbian_signed/index.php" id="rollover_symbian_signed"><span>Symbian Signed</span></a></h2>
          <p>Symbian Signed is managed by the Symbian Foundation on behalf of the community and allows developers to sign an application for deployment to Symbian devices.</p>
        </div>
		
		  <div class="left BoxFrame two_col" style="min-height: 145px;margin-bottom:20px;"> <a href="/main/services/professional_services/index.php"><img src="/img/landing_pages/sf_devimg_27a.gif" alt="Professional services" border="0" class="community_image right" /></a>
          <h2 class="cssImg community_header"><a href="/main/services/professional_services/index.php" id="rollover_t_professional_services"><span>Training</span></a></h2>
          <p>Need assistance with design, testing, customization or localization of your Symbian platform-based product? Start your search here.</p>
        </div>
		
        <div class="right BoxFrame two_col" style="min-height: 145px;margin-bottom:20px;"> <a href="/main/services/tech_support/index.php"><img src="/img/landing_pages/sf_devimg_08_small.gif" alt="Tech support"  border="0" class="community_image right" /></a>
          <h2 class="cssImg community_header"><a href="/main/services/tech_support/index.php" id="rollover_tech_support"><span>Tech Support</span></a></h2>
          <p>Want technical support? If you need more than you can  get on the <a href="/forum/">developer forums</a>, a number of member companies offer  contract-based and incident-based support.</p>
        </div>
		 
        <div class="left BoxFrame two_col" style="min-height: 145px;"> <a href="/main/services/training/index.php"><img src="/img/landing_pages/sf_webdev_09.gif" alt="Training" border="0" class="community_image right" /></a>
          <h2 class="cssImg community_header"><a href="/main/services/training/index.php" id="rollover_training"><span>Training</span></a></h2>
          <p>Symbian platform training can make you more productive, faster.</p>
        </div>
